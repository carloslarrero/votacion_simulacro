        ...
        titleTop: SingleChildScrollView(
          ...
          child: Row(
            children: [
              ...
              const Text('MISIONES', style: TextStyle(color: Colors.white)),
              SizedBox(width: size.width * 0.02),
              const Text('Distrito: ', style: TextStyle(color: Colors.white)),
              const Text('SANTIAGO', style: TextStyle(color: Colors.white)),
              SizedBox(width: size.width * 0.02),
